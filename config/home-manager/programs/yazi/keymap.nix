  ...
  mgr = {
    keymap = [
      ...
      }
      {
        ...
        run = "cd ~/.dotfiles/config/home-manager";
        desc = "home-manager";
      }
      {
        on = [
